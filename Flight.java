import java.util.Scanner;
   ...
   public class Flight {
    public static void main (String [] args) {
        ...
        System.out.println("How would you like your metrics: kilometers, miles, or nautical miles?");
        Scanner scanner = new Scanner(System.in);
        String reader = scanner.nextLine();
        if (reader.equalsIgnoreCase("miles")) {
            System.out.println("The distance from home to destination is " + distance + " miles");
        }
        else if (reader.equalsIgnoreCase("kilometers")){
            double kilometers = distance*1.609;
            System.out.println("The distance from home to destination is " + kilometers + " kilometers");
        }
        else if (reader.equalsIgnoreCase("nautical miles")) {
            double nauticalmiles = distance/1.151;
            System.out.println("The distance from home to destination is " + nauticalmiles + " nautical miles");
        }
        ...
        String reader2 = scanner2.nextLine();


        if (reader2.equalsIgnoreCase("yes")||reader2.equalsIgnoreCase("yea")) {
